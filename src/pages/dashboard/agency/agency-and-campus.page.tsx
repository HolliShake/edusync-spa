...
import { School, Building2, Repeat, Map } from "lucide-react";
                            ...
                            {profileFields.map(({ label, value, mono }, i) => (
                                ...
                                >
                                    ...
                                    <p className={cn(
                                        ...
                                        {value ?? (
                                            <span className="italic font-normal text-muted-foreground">N/A</span>
                                        )}
                                    </p>
                                </div>
                            ))}
                    ...
                    <Tabs defaultValue={defaultTab} className="w-full block">
                        <TabsList className="flex! w-full! h-auto bg-muted/50 border border-border p-1 rounded-xl gap-1 mb-4">
                            {TABS.map(({ value, icon: Icon, label }) => (
                                <TabsTrigger key={value} value={value} className={TRIGGER_BASE} onClick={() => {
                                    navigate('?tab=' + value);
                                }}>
                                    ...
                                    <div className="px-5 py-8">
                                        {(value === 'colleges' 
                                            ...
                                            : (value === 'building'
                                                ...
                                                : (value === 'cycle'
                                                    ? <div>Cycle content goes here</div>
                                                    : <div>Map view content goes here</div>
                                                )
                                            )
                                        )}
                                    </div>
