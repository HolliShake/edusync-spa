...
import type { GetCollegeDto, GetPaginatedResponseDtoOfGetCollegeDto } from '@/lib/orval/model';
...
export default function CampusCollegesTab({ campusId }: CampusCollegesTabProps): React.ReactNode {
  const [collegePaginated, setCollegePaginated] =
    useState<GetPaginatedResponseDtoOfGetCollegeDto | null>(null);
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end">
                <DropdownMenuItem
                  ...
                  onClick={() => handleEdit(row as unknown as GetCollegeDto)}
                >
                ...
                <DropdownMenuItem
                  ...
                  onClick={() => handleDelete(row as unknown as GetCollegeDto)}
    ...
    <div className="w-full">
      ...
      <Modal controller={modal} title={modal.data ? 'Edit College' : 'Add College'} size="sm">
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div>
            <label htmlFor="collegeShortName" className="block text-sm font-medium mb-1">
              Short Name
            </label>
            <Input
              id="collegeShortName"
            ...
            {form.formState.errors.collegeShortName && (
              <div className="text-xs text-red-500 mt-1">
                {form.formState.errors.collegeShortName.message}
              </div>
            )}
          </div>
