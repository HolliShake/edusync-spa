        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            <DropdownMenuItem
              ...
              onClick={() => handleTransfer(row as EnrollmentBackdoorDto)}
            >
              ...
              {selectedCampus ? (
                <>
                  ...
                  <span className="font-semibold text-foreground">
                    {studentData.paginationMeta.totalItems}
                  </span>{' '}
                  record(s) — Page{' '}
                  <span className="font-semibold text-foreground">
                    {studentData.paginationMeta.page}
                  </span>{' '}
                  of{' '}
                  <span className="font-semibold text-foreground">
                    {studentData.paginationMeta.totalPages}
                  </span>
                </>
              ) : (
                'No campus selected.'
