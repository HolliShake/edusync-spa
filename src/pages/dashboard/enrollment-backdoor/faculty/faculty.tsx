...
const buildFacultyColumns = (
    ...
    render: (_, row) => (
      <div className="flex flex-col gap-0.5">
        <span className="text-sm font-medium">
          {row.academicProgram?.college?.campus?.campusShortName ?? '—'}
        </span>
        <span className="text-xs text-muted-foreground">
          {row.academicProgram?.college?.campus?.campusName}
        </span>
      </div>
    ),
  },
  {
    ...
    render: (_, row) => (
      <div className="flex flex-col gap-0.5">
        <span className="text-sm font-medium">
          {row.academicProgram?.college?.collegeShortName ?? '—'}
        </span>
        <span className="text-xs text-muted-foreground">
          {row.academicProgram?.college?.collegeName}
        </span>
      </div>
    ),
  },
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            <DropdownMenuItem
              ...
              onClick={() => handleSelect(row as EnrollmentBackdoorDto)}
            >
            ...
            <DropdownMenuItem
              className="cursor-pointer flex items-center gap-2"
              onClick={() => handleEdit(row as EnrollmentBackdoorDto)}
            >
            ...
            <DropdownMenuItem
              ...
              onClick={() => handleDelete(row as EnrollmentBackdoorDto)}
            >
